...
3. For each cluster: gathers context, matches against existing Vendor resources; if no confident match, synthesizes a new Vendor resource via `yield.fromContext`.
